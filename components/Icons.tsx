...
export function MailIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      ...
      <path d="m4 7 7.2 5.4a1.3 1.3 0 0 0 1.6 0L20 7" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} {...props}>
      <path
        ...
        d="M12 2.5c-5.25 0-9.5 4.25-9.5 9.5 0 4.2 2.73 7.77 6.51 9.03.48.09.65-.21.65-.46 0-.23-.01-1-.01-1.82-2.65.48-3.34-.65-3.55-1.24-.12-.31-.63-1.24-1.08-1.5-.37-.2-.9-.68-.01-.69.83-.01 1.42.76 1.62 1.08.95 1.6 2.47 1.15 3.07.87.09-.68.36-1.15.65-1.41-2.27-.26-4.65-1.14-4.65-5.06 0-1.12.4-2.03 1.06-2.75-.11-.26-.46-1.33.1-2.77 0 0 .87-.28 2.85 1.05a9.8 9.8 0 0 1 5.19 0c1.98-1.33 2.85-1.05 2.85-1.05.56 1.44.21 2.51.1 2.77.66.72 1.06 1.62 1.06 2.75 0 3.93-2.39 4.8-4.66 5.05.37.32.68.94.68 1.9 0 1.37-.01 2.47-.01 2.81 0 .25.17.56.65.46A9.53 9.53 0 0 0 21.5 12c0-5.25-4.25-9.5-9.5-9.5Z"
      />
    </svg>
  );
}
